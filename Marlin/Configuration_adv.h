...
#define SENSORLESS_BACKOFF_MM  { 2, 2 }     // (mm) Backoff from endstops before sensorless homing //MARC

#define HOMING_BUMP_MM      { 5, 5, 2 }       // (mm) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)

#define HOMING_BACKOFF_POST_MM { 2, 2, 2 }  // (mm) Backoff from endstops after homing //MARC
 ...
 */
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      500 //MARC STROM
    #define E0_MICROSTEPS    16
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define Y_STALL_SENSITIVITY  130 //MARC
 ...
 */
//#define STARTUP_COMMANDS "M17 Z" //MARC
